...
class Graphics:
    ...
    def draw(self, environment, demonstration_visualisation_lines, policy_visualisation_lines):
        # Clear the screen
        ...
        font = pygame.font.SysFont('Arial', 30)
        text_surface = font.render('Demonstrations', True, (255, 255, 255))
        self.screen.blit(text_surface, (1.4 * config.WINDOW_SIZE, 0.2 * constants.WINDOW_HEADER))
        font = pygame.font.SysFont('Arial', 30)
        text_surface = font.render('Policy', True, (255, 255, 255))
        ...
        self.draw_visualisation_lines(demonstration_visualisation_lines, policy_visualisation_lines)
    ...
    def draw_visualisation_lines(self, demonstration_visualisation_lines, policy_visualisation_lines):
        # Planning
        for visualisation in demonstration_visualisation_lines:
        ...
        # Model
        for visualisation in policy_visualisation_lines:
            # For each visualisation, get the attributes necessary to create a pygame line
            start_pos = self.world_pos_to_window_pos([visualisation.x1, visualisation.y1])
            end_pos = self.world_pos_to_window_pos([visualisation.x2, visualisation.y2])
            width = self.world_len_to_window_len(visualisation.width)
